...
**Shape of AI**（https://www.shapeof.ai/）是 Emily Campbell 维护的一个 AI 产品交互模式分类库。它将当前 AI 产品界面中反复出现的设计模式归纳为 6 大类、42 个具体模式，为 AI 产品设计师和开发者提供参考词汇表。
...
- **产品自检**：在 AI 功能设计评审时，对照 42 个模式检查是否覆盖了关键交互场景
