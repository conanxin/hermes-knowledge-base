...
**Canonical URL**：https://martinfowler.com/articles/is-quality-worth-cost.html
...
I thus divide software quality attributes into external (such as the UI and defects) and internal (architecture). The
...
I like to illustrate this point with a tale of when I was chatting with
      ...
      do we understand how we should have built it”.
...
As I mentioned above, we don't really know how to measure internal
      ...
      there has been increasing efforts to try.

One particularly interesting paper that I've come across is this study
      from Adam Tornhill and Markus Borg .
      ...
      and that low quality code had 15 times higher defect density.

Significant Revisions

29 May 2019: published
